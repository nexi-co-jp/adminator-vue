                    ...
                    <ul class="sidebar-menu scrollable pos-r">
                        ...
                        <li class="nav-item">
                            <a class="sidebar-link" href="calendar.html"
                                ><span class="icon-holder"
                                    ><i
                                        class="c-deep-orange-500 ti-calendar"
                                    ></i> </span
                        ...
                        <li class="nav-item">
                            <a class="sidebar-link" href="charts.html"
                                ><span class="icon-holder"
                                    ><i
                                        class="c-indigo-500 ti-bar-chart"
                                    ></i> </span
...
export default {
    ...
    data: () => ({
        isCollapsed: true,
        items: [
            { icon: 'c-brown-500 ti-email', text: 'AA01', url: '/aa' },
            { icon: 'c-brown-500 ti-email', text: 'AA02', url: '/aa' },
            { icon: 'c-brown-500 ti-email', text: 'AA03', url: '/aa' },
            { icon: 'c-brown-500 ti-email', text: 'AA04', url: '/aa' },
            { icon: 'c-brown-500 ti-email', text: 'AA05', url: '/aa' },
            {
                icon: 'c-brown-500 ti-email',
                text: 'AAA',
                url: '/aa',
                children: [
                    { icon: 'c-blue-500 ti-share', text: 'AAA11', url: '/aa' },
                    { icon: 'c-blue-500 ti-share', text: 'AAA22', url: '/aa' },
                    {
            ...
            { icon: 'c-blue-500 ti-share', text: 'AAA', url: '/aa' },
            { icon: 'c-brown-500 ti-email', text: 'AAA', url: '/aa' },
            { icon: 'c-brown-500 ti-email', text: 'AAA', url: '/aa' },
        ],
    }),
    computed: {
