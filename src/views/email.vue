        ...
        <div class="email-wrapper row remain-height bgc-white ov-h">
            <div class="email-list h-100 layers">
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    >
                                        <li>
                                            <a
                                                href=""
                                                class="d-b td-n pY-5 pX-10 bgcH-grey-100 c-grey-700"
                                            >
                ...
                <div class="layer w-100 fxg-1 scrollable pos-r ps ps--active-y">
                    <div class="">
                        ...
                        >
                            ...
                            <div class="peer peer-greed ov-h">
                                ...
                                <h5 class="fsz-def tt-c c-grey-900">
                                    title goes here
                                </h5>
                    ...
                    <div
                        class="ps__rail-y"
                        style="top: 0px; height: 715px; right: 0px;"
                    >
                        <div
                            class="ps__thumb-y"
                            tabindex="0"
                            style="top: 0px; height: 338px;"
                        ></div>
                    </div>
                </div>
            </div>
            <div class="email-content h-100">
                <div class="h-100 scrollable pos-r ps">
                    <div
                        class="bgc-grey-100 peers ai-c jc-sb p-20 fxw-nw d-n@md+"
                    >
                        <div class="peer">
                            <div class="btn-group" role="group">
                                <button
