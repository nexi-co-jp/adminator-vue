<template>
    <div
        ...
        style="position: relative; height: 1281.22px;"
    >
        ...
        <div
            class="masonry-item col-md-6"
            style="position: absolute; left: 49.9992%; top: 0px;"
        >
            <div class="bgc-white p-20 bd">
                ...
                <div class="mT-30">
                    <div class="gap-10 peers">
                        ...
                        <div class="peer">
                            <button type="button" class="btn cur-p btn-info">
                                Info
                            </button>
                        </div>
                        <div class="peer">
                            <button type="button" class="btn cur-p btn-light">
                                Light
                            </button>
                        </div>
                        <div class="peer">
                    ...
                    <div class="w-100 gap-10 peers mY-20">
                        ...
                        <div class="peer">
                            <button
                                type="button"
                                class="btn cur-p btn-outline-warning"
                            >
                                Warning
                            </button>
                        </div>
                        <div class="peer">
                            <button
                                type="button"
                                class="btn cur-p btn-outline-info"
                            >
                                Info
                            </button>
                        </div>
                        <div class="peer">
                            <button
                                type="button"
                                class="btn cur-p btn-outline-light"
                            >
                                Light
                            </button>
                        </div>
                        <div class="peer">
                            <button
                                type="button"
                                class="btn cur-p btn-outline-dark"
                            >
                                Dark
                            </button>
                        </div>
        ...
        <div
            class="masonry-item col-md-6"
            style="position: absolute; left: 49.9992%; top: 358px;"
        >
            <div class="bgc-white p-20 bd">
        ...
        <div
            class="masonry-item col-md-6"
            style="position: absolute; left: 49.9992%; top: 561px;"
        >
            <div class="bgc-white p-20 bd">
        ...
        <div
            class="masonry-item col-md-6"
            style="position: absolute; left: 0%; top: 617px;"
        >
            <div class="bgc-white p-20 bd">
        ...
        <div
            class="masonry-item col-md-6"
            style="position: absolute; left: 0%; top: 765px;"
        >
            <div class="bgc-white p-20 bd">
        ...
        <div
            class="masonry-item col-md-6"
            style="position: absolute; left: 49.9992%; top: 819.219px;"
        >
            <div class="bgc-white p-20 bd">
        ...
        <div
            class="masonry-item col-md-6"
            style="position: absolute; left: 0%; top: 913px;"
        >
            <div class="bgc-white p-20 bd">
