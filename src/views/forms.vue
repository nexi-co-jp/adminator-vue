<template>
    <div
        ...
        style="position: relative; height: 1097px;"
    >
            ...
            <div class="bgc-white p-20 bd">
                ...
                <div class="mT-30">
                    <form>
                        ...
                        <div
                            class="checkbox checkbox-circle checkbox-info peers ai-c mB-15"
                        >
                            <input
                                type="checkbox"
                                id="inputCall1"
        ...
        <div
            class="masonry-item col-md-6"
            style="position: absolute; left: 0%; top: 365px;"
        >
            <div class="bgc-white p-20 bd">
        ...
        <div
            class="masonry-item col-md-6"
            style="position: absolute; left: 50.0002%; top: 601px;"
        >
            <div class="bgc-white p-20 bd">
        ...
        <div
            class="masonry-item col-md-6"
            style="position: absolute; left: 0%; top: 789px;"
        >
            <div class="bgc-white p-20 bd">
