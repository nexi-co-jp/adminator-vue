<template>
    <div
        ...
        style="position: relative; height: 2411px;"
    >
        ...
        <div
            ...
            style="position: absolute; left: 0%; top: 124px;"
        >
                        ...
                        <div class="layers">
                           ...
                           "
                                    >
                                        ...
                                        >
                                            <svg width="840.797" height="490">
                                                <defs></defs>
                                                <g
                                                    transform="scale(0.9342188888888889) translate(0, 41.898018216802114)"
                                                >
                                                    <path
                                                ...
                                                <g>
                                                    <circle
                                                        data-index="0"
                                                        cx="575.7286055505934"
                                                        cy="255.44916378563772"
                                                        fill="#fff"
                                                        stroke="#000"
                                                        fill-opacity="1"
                                                        stroke-width="2"
                                                    ...
                                                    <circle
                                                        data-index="1"
                                                        cx="746.4981499129414"
                                                        cy="385.37742875675644"
                                                        fill="#fff"
                                                        stroke="#000"
                                                        fill-opacity="1"
                                                        stroke-width="2"
                                                    ...
                                                    <circle
                                                        data-index="2"
                                                        cx="113.9256500359209"
                                                        cy="215.22911775771897"
                                                        fill="#fff"
                                                        stroke="#000"
                                                        fill-opacity="1"
                                                        stroke-width="2"
                                                    ...
                                                    <circle
                                                        data-index="3"
                                                        cx="385.2854739541723"
                                                        cy="160.52181008270634"
                                                        fill="#fff"
                                                        stroke="#000"
                                                        fill-opacity="1"
                                                        stroke-width="2"
                                                    ...
                                                    <circle
                                                        data-index="4"
                                                        cx="522.5561159155775"
                                                        cy="245.0880672459405"
                                                        fill="#fff"
                                                        stroke="#000"
                                                        fill-opacity="1"
                                                        stroke-width="2"
        ...
        <div
            ...
            style="position: absolute; left: 0%; top: 1257px;"
        >
            <div class="bd bgc-white">
                <div class="layers">
        ...
        <div
            class="masonry-item col-md-6"
            style="position: absolute; left: 49.9992%; top: 1257px;"
        >
        ...
        <div
            class="masonry-item col-md-6"
            style="position: absolute; left: 0%; top: 1553px;"
        >
            <div class="bd bgc-white">
                <div class="layers">
                    <div class="layer w-100 p-20">
        ...
        <div
            class="masonry-item col-md-6"
            style="position: absolute; left: 49.9992%; top: 1621px;"
        >
            <div class="bd bgc-white p-20">
                <div class="layers">
        ...
        <div
            class="masonry-item col-md-6"
            style="position: absolute; left: 49.9992%; top: 2041px;"
        >
            <div class="bd bgc-white">
                <div class="layers">
                    <div class="layer w-100 p-20">
