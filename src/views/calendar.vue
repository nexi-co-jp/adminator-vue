                        ...
                        <ul class="m-0 p-0 mT-20">
                            <li class="bdB peers ai-c jc-sb fxw-nw">
                                ...
                                >
                                    <div class="peer mR-15">
                                        <i
                                            class="fa fa-fw fa-clock-o c-red-500"
                                        ></i>
                                    </div>
                                    <div class="peer">
                                        <span class="fw-600">
                            ...
                            <li class="bdB peers ai-c jc-sb fxw-nw">
                                ...
                                >
                                    <div class="peer mR-15">
                                        <i
                                            class="fa fa-fw fa-clock-o c-blue-500"
                                        ></i>
                                    </div>
                                    <div class="peer">
                                        <span class="fw-600">
                            ...
                            <li class="bdB peers ai-c jc-sb fxw-nw">
                                ...
                                >
                                    <div class="peer mR-15">
                                        <i
                                            class="fa fa-fw fa-clock-o c-indigo-500"
                                        ></i>
                                    </div>
                                    <div class="peer">
                                        <span class="fw-600">
                            ...
                            <li class="bdB peers ai-c jc-sb fxw-nw">
                                ...
                                >
                                    <div class="peer mR-15">
                                        <i
                                            class="fa fa-fw fa-clock-o c-green-500"
                                        ></i>
                                    </div>
                                    <div class="peer">
                                        <span class="fw-600">
            ...
            <div class="col-md-8">
                <div id="full-calendar" class="fc fc-unthemed fc-ltr">
                    <div class="fc-toolbar fc-header-toolbar">
                        ...
                        <div class="fc-center"><h2>July 2020</h2></div>
                                    ...
                                    <tr>
                                        <td class="fc-widget-content">
                                            <div
                                                ...
                                                style="overflow: hidden; height: 666.747px;"
                                            >
                                                <div
        ...
        <div class="modal fade" id="calendar-edit">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="bd p-15"><h5 class="m-0">Add Event</h5></div>
